...
silent only
cd ~/.rvm/gems/ruby-1.9.3-p194@rails328/gems/browsercms-3.5.5
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 config/routes.rb
badd +0 ~/rails-app/browsercms-demo/config/routes.rb
args config/routes.rb
...
86
normal! 0
tabedit ~/rails-app/browsercms-demo/config/routes.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 64 - ((63 * winheight(0) + 43) / 86)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
